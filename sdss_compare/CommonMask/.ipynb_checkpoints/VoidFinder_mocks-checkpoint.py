...
for i in range (25):
    ...
    out_dir = './altmtl/'
    galaxies_filename = f'./altmtl/altmtl{i}_ngc.fits'
    survey_name =  f'altmtl{i}'
    
    void_finder(galaxies_filename, survey_name, out_dir, -20.0)
...
for i in idx_list:
    ...
    out_dir = './HR4/'
    galaxies_filename = f'./HR4/DR7m_{i}.fits'
    survey_name = f'HR4_{i}'
    
    void_finder(galaxies_filename, survey_name, out_dir, None)